...
@section('title', 'Payment deliveryman')
@section('content')
    @if (session('success'))
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <div class="box-content mb-5">
                <form action="{{ url('superadmin/deliveryman-payment') }}" method="POST">
                    @csrf
                    <div class="row">
                        @if ($type != 'paid')
                        ...
                        <table id="payment" class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-right"> @lang('common.deliveryman') @lang('common.total')</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($deliveryman_parcels as $parcel)
                                    <tr class="ml-1 sparent">
                                        ...
                                        <td>
                                            @if ($parcel->deliveryman_paid > 0)
                                                <a href="{{ url('superadmin/deliveryman-payment-invoice/'.$parcel->id) }}" target="_blank" class="btn btn-sm btn-info">
                                                @lang('common.invoice')
                                                </a>
                                            @endif
                                        </td>
                                ...
                                <tr class="ml-1 sparent">
                                    ...
                                    <th class="text-right">{{ $deliveryman_parcels->sum('deliveryman_amount') }}</th>
                                    <th class="text-right">
