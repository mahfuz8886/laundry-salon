...
@section('deliveryman_based_parcels', 'active')
@section('title', 'Deliveryman Based Parcels')
@section('extracss')
    <style>
        .logo {
            padding: 10px;
...
@section('content')
    <section class="content">
        <div class="content-fluid">
            <h4> @lang('common.deliveryman_based_report') </h4>
            <div class="card">
                <div class="card-body">
                    <form action="">
                        <div class="row mt-4">
                ...
                <div class="print_area">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    <h3 class="text-center"> @lang('common.deliveryman_based_report') </h3>
                                ...
                                <div class="col-sm-12">
                                    <span class="deliveryman_info pull-left">
                                        <b>@lang('common.deliveryman') @lang('common.name'):</b> {{ $deliveryman_info->name ?? '' }}
                                        {{ $deliveryman_info->phone ?? '' }}
                                    </span>
                                        ...
                                        <tbody>
                                            @foreach ($parcels as $key => $parcel)
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        {{ number_format($parcel->deliveryman_amount, 2) }}</td>
                                                    ...
                                                    <td class="text-right">
                                                        {{ number_format($parcel->deliveryman_due, 2) }}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                        <tfoot>
