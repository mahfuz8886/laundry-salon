    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('superadmin.salon.updateDiscount') }}" method="POST">
                      @csrf
                        <div class="form-row">
                        ...
                        <div class="form-row">
                          <div class="form-group col-md-6">
                            ...
                            <select name="service" class="form-control select2" id="service" required>
                                ...
                                <option {{ $discount->service_id==$service->id? 'selected':'' }} value="{{ $service->id }}">{{ $service->service_name }}</option>
                                @endforeach
                            </select>
                          </div>
