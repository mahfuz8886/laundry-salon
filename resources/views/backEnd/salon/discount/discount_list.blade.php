            ...
            <div class="row">
                <div class="col-12">
                    <div class="box-content">
                        <p class="text-right">
                            <a href="{{ route('superadmin.salon.addDiscount') }}" class="btn btn-sm btn-primary">@lang('common.add_new_discount')</a>
                        </p>
                        <div class="card">
                                ...
                                <div class="teble-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="pl-4">
                                                    <a class="pr-2" href="{{ route('superadmin.salon.getDiscount', $discount->id) }}"><i class="fa fa-edit text-primary"></i></a>
                                                </td>
