...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="{{ route('superadmin.account.updateSalonExpanse') }}" method="POST">
                @csrf
                <input type="hidden" name="id" value="{{ $income->id }}">
                <div class="card">
                    <h5 class="card-header text-uppercase">@lang('common.edit_expanse')</h5>
                    <div class="card-body">
                        <div class="form-row">
