...
@section('add_expanse', 'active')
@section('title', 'Add Expanse')
...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="{{ route('superadmin.account.storeSalonExpanse') }}" method="POST">
                @csrf
                <div class="card">
                    <h5 class="card-header text-uppercase">@lang('common.add_expanse')</h5>
                    <div class="card-body">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input readonly type="text" name="invoice_no" value="{{ old('invoice_no', $invoice_no) }}"
                                    class="form-control">
                            </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select name="payment_method" id="payment_method" class="form-control" required>
                                    ...
                                    <option value="5" @if (old('payment_method') == 3) selected @endif>
                            ...
                            <table class="table table-striped w-100">
                                    ...
                                    <tr class="item">
                                        ...
                                        <td>
                                            <select name="account_head_id[]" id="account_head_id" class="form-control account_head_id" required>
                                                @php
                                                    $accounts = App\AccountHead::where('head_type', 4)->where('status', 1)->get();
                                                @endphp
                                                <option value="">@lang('common.choose')</option>
                                ...
                                <tfoot>
                                    <th colspan="3">
                                        ...
                                        <td>
                                            <input readonly type="text" id="sub_total" name="sub_total" class="form-control sub_total" required>
                                        </td>
                                    </th>
                                </tfoot>
