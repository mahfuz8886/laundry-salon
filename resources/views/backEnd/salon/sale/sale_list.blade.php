...
@section('quick_sale', 'active menu-open')
@section('manage_quick_sale', 'active')
@section('title', 'Sales')
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="payment_status" class="form-control select2">
                                        <option value=""></option>
                                        <option @if (Request::get('payment_status')) {{ $_GET['payment_status'] == 1 ? 'selected':''  }} @endif value="1"> Paid </option>
                                        <option @if (Request::get('payment_status')) {{ $_GET['payment_status'] == 0 ? 'selected':''  }} @endif value="0"> Unpaid </option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-6">
