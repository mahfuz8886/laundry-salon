                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8">
                                <div class="card card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">@lang('common.update_logo')</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form role="form" action="{{ url('editor/logo/update') }}" method="POST"
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="file"
                                                    ...
                                                    id="image">
                                                <img src="{{ asset($edit_data->image) }}" class="" height="100" alt="">
                                                @if ($errors->has('image'))
