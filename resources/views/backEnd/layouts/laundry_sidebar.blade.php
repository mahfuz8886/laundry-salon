<nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        @can('dashboard')
            <li class="nav-item">
                <a href="{{ url('superadmin/laundrydashboard') }}" class="nav-link @yield('dashboard')">
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item has-treeview @yield('items')">
                        ...
                        <ul class="nav nav-treeview nav-subtreeview">
                            @can('user_add')
                            <li class="nav-item">
                                <a href="{{ route('superadmin.laundry.addItem') }}" class="nav-link @yield('add_item')">
                                    <p>
                                        @lang('common.add')
                                    </p>
                                </a>
                            ...
                            @can('user_add')
                            <li class="nav-item">
                                <a href="{{ route('superadmin.laundry.manageItem') }}" class="nav-link @yield('manage_item')">
                                    <p>
                                        @lang('common.manage')
                                    </p>
                                </a>
                    ...
                    <li class="nav-item has-treeview @yield('purchase')">
                        ...
                        <ul class="nav nav-treeview nav-subtreeview">
                            @can('user_add')
                            <li class="nav-item">
                                <a href="{{ route('superadmin.laundry.addPurchase') }}" class="nav-link @yield('add_purchase')">
                                    <p>
                                        @lang('common.add')
                                    </p>
                                </a>
                            ...
                            @can('user_add')
                            <li class="nav-item">
                                <a href="{{ route('superadmin.laundry.managePurchase') }}" class="nav-link @yield('manage_purchase')">
                                    <p>
                                        @lang('common.manage')
                                    </p>
                                </a>
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item has-treeview @yield('laundry_discount')">
                        ...
                        <ul class="nav nav-treeview nav-subtreeview">
                            @can('user_add')
                            <li class="nav-item">
                                <a href="{{ route('superadmin.laundry.addDiscount') }}" class="nav-link @yield('add_ldiscount')">
                                    <p>
                                        @lang('common.add')
                                    </p>
                                </a>
                            ...
                            @can('user_add')
                            <li class="nav-item">
                                <a href="{{ route('superadmin.laundry.manageDiscount') }}" class="nav-link @yield('manage_ldiscount')">
                                    <p>
                                        @lang('common.manage')
                                    </p>
                                </a>
    ...
    @endcan
        ...
        @can('panel_user')
            <li class="nav-item has-treeview @yield('product_section')">
                <a href="#" class="nav-link">
                    ...
                    <p>
                        @lang('common.laundry_product_section')
                        <i class="right fa fa-angle-left"></i>
                    </p>
                </a>
                <ul class="nav nav-treeview">
                    @can('user_add')
                    <li class="nav-item">
                        <a href="{{ route('superadmin.laundry.addCategory') }}" class="nav-link @yield('category')">
                            <p>
                    ...
                    @can('user_add')
                    <li class="nav-item">
                        <a href="{{ route('superadmin.laundry.addService') }}" class="nav-link @yield('service')">
                            <p>
                                @lang('common.service')
                            </p>
                        </a>
                    ...
                    <li class="nav-item has-treeview @yield('product')">
                        ...
                        <ul class="nav nav-treeview nav-subtreeview">
                            @can('user_add')
                            <li class="nav-item">
                                <a href="{{ route('superadmin.laundry.addProduct') }}" class="nav-link @yield('add_product')">
                                    <p>
                                        @lang('common.add')
                                    </p>
                                </a>
                            ...
                            @can('user_add')
                            <li class="nav-item">
                                <a href="{{ route('superadmin.laundry.listProduct') }}" class="nav-link @yield('list_product')">
                                    <p>
                                        @lang('common.manage')
                                    </p>
                                </a>
        ...
        @can('panel_user')
            <li class="nav-item has-treeview @yield('laundry_order_section')">
                <a href="#" class="nav-link">
                    <i class="fas fa-shopping-cart"></i>
                    <p>
                        @lang('common.laundry_order')
                        <i class="right fa fa-angle-left"></i>
                    </p>
                </a>
                <ul class="nav nav-treeview">
                    @can('user_add')
                    <li class="nav-item">
                        <a href="{{ route('superadmin.laundry.orders') }}" class="nav-link @yield('orders')">
                            <p>
                                @lang('common.orders')
                            </p>
                        </a>
                    ...
                    <li class="nav-item has-treeview @yield('offline_order')">
                        ...
                        <ul class="nav nav-treeview nav-subtreeview">
                            @can('user_add')
                            <li class="nav-item">
                                {{-- <a href="{{ route('superadmin.laundry.addOrders') }}" class="nav-link @yield('add_offline_order')">
                                    <p>
                                        @lang('common.add')
                                    </p>
                                </a> --}}
                                <a href="{{ route('superadmin.laundry.quickSaleLaundry') }}" class="nav-link @yield('add_offline_order')">
                                    <p>
                                        @lang('common.add')
                                    </p>
                                </a>
                            ...
                            @can('user_add')
                            <li class="nav-item">
                                <a href="{{ route('superadmin.laundry.manageOfflineOrder') }}" class="nav-link @yield('manage_offline_order')">
                                    <p>
                                        @lang('common.manage')
                                    </p>
                                </a>
        ...
        <li class="nav-item has-treeview @yield('package')">
            ...
            <ul class="nav nav-treeview nav-subtreeview">
                @can('user_add')
                <li class="nav-item">
                    <a href="{{ route('superadmin.laundry.addPackage') }}" class="nav-link @yield('add_package')">
                        <p>
                            @lang('common.add')
                        </p>
                    </a>
                ...
                @can('user_add')
                <li class="nav-item">
                    <a href="{{ route('superadmin.laundry.managePackage') }}" class="nav-link @yield('manage_package')">
                        <p>
                            @lang('common.manage')
                        </p>
                    </a>
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item has-treeview @yield('income')">
                        ...
                        <ul class="nav nav-treeview nav-subtreeview">
                            @can('user_add')
                            <li class="nav-item">
                                <a href="{{ route('superadmin.account.addIncome') }}" class="nav-link @yield('add_income')">
                                    <p>
                                        @lang('common.add')
                                    </p>
                                </a>
                            ...
                            @can('user_add')
                            <li class="nav-item">
                                <a href="{{ route('superadmin.account.incomeList') }}" class="nav-link @yield('income_list')">
                                    <p>
                                        @lang('common.manage')
                                    </p>
                                </a>
                    ...
                    <li class="nav-item has-treeview @yield('expanse')">
                        ...
                        <ul class="nav nav-treeview nav-subtreeview">
                            @can('user_add')
                            <li class="nav-item">
                                <a href="{{ route('superadmin.account.addExpanse') }}" class="nav-link @yield('add_expanse')">
                                    <p>
                                        @lang('common.add')
                                    </p>
                                </a>
                            ...
                            @can('user_add')
                            <li class="nav-item">
                                <a href="{{ route('superadmin.account.expanseList') }}" class="nav-link @yield('expanse_list')">
                                    <p>
                                        @lang('common.manage')
                                    </p>
                                </a>
        ...
        @can('panel_user')
            <li class="nav-item has-treeview @yield('report_section')">
                ...
                <ul class="nav nav-treeview">
                    @can('user_add')
                    <li class="nav-item">
                        <a href="{{ route('superadmin.laundry.summaryReport') }}" class="nav-link @yield('lsummary')">
                            <p>
                                @lang('common.summary')
                            </p>
                        </a>
