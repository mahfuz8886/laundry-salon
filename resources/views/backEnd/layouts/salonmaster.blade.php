...
<head>
    ...
    <title>Salon || @yield('title', 'Dashbaord')</title>
...
<body class="hold-transition sidebar-mini layout-fixed" onload="startTime()">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a href="{{ url('/superadmin/salondashboard') }}" class="brand-link">
                <span class="brand-text text-success font-weight-light">@lang('common.sensor_courier')</span>
            </a>
