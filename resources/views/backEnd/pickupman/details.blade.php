...
@section('title', 'Pickupman Detail')
@section('extracss')
    <style>
        .table th {
                            ...
                            <div class="col-sm-12">
                                <div class="manage-button">
                                    <div class="body-title">
                                        <h5>@lang('common.pickupman') @lang('common.details')</h5>
                                    </div>
                                    <div class="quick-button">
                                        <a href="{{ url('admin/pickupman/manage') }}"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 text-center">
                                                <div class="form-group">
                                                    <label for="image"> @lang('common.pickupman') @lang('common.photo') </label>
                                                    <div>
                                                        <img src="{{ url($pickupman->image) }}" alt="Photo" width="100"
                                                            height="100">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $pickupman->alternative_phone }}</td>
                                                    </tr>
                                                    <tr>
                                                        <th> @lang('common.nid_number') </th>
                                                        <td>{{ $pickupman->nid_no }}</td>
                                                    </tr>
                                                    <tr>
                                                        <th> @lang('common.father_name') </th>
                                                        <td>{{ $pickupman->fathers_name }}</td>
                                                    </tr>
                                                    
                                                    <tr>
                                                        <th> @lang('common.mother_name') </th>
                                                        <td>{{ $pickupman->mothers_name }}</td>
                                                    </tr>
                                                    
                                                    <tr>
                                                        <th> @lang('common.dob') </th>
                                                        <td>{{ $pickupman->birth_date ? date('d-F-Y', strtotime($pickupman->birth_date)) : '' }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $pickupman->marital_status }}</td>
                                                    </tr>
                                                    <tr>
                                                        <th> @lang('common.designation') </th>
                                                        <td>{{ $pickupman->designation }}</td>
                                                    </tr>
                                                    <tr>
                                                        <th> @lang('common.per_parcel_amount') </th>
                                                        <td>{{ $pickupman->per_parcel_amount }}</td>
                                                    </tr>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr>
                                                        <th width="200"> @lang('common.name') </th>
                                                        <td> {{ $pickupman->guaranteer_name }} </td>
                                                    </tr>
                                                    <tr>
                                                        <th width="200"> @lang('common.relation') </th>
                                                        <td> {{ $pickupman->guaranteer_relation }} </td>
                                                    </tr>
                                                    <tr>
                                                        <th width="200"> @lang('common.nid_number') </th>
                                                        <td> {{ $pickupman->guaranteer_nid_no }} </td>
                                                    </tr>
                                                    <tr>
                                                        <th width="200"> @lang('common.mobile_no') </th>
                                                        <td> {{ $pickupman->guaranteer_mobile_no }} </td>
                                                    </tr>
                                                    <tr>
                                                        <th width="200"> @lang('common.present_address') </th>
                                                        <td> {{ $pickupman->guaranteer_present_address }} </td>
                                                    </tr>
                                                    <tr>
                                                        <th width="200"> @lang('common.permanent_address') </th>
                                                        <td> {{ $pickupman->guaranteer_permanent_address }} </td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </div>
    ...
    <script>
        $(function() {
            ...
            $('body').on('change', '#division_id', function() {
                ...
                var selected = '{{ old('district_id', $pickupman->district_id) }}';
                $.ajax({
                    method: "GET",
