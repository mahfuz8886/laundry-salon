...
@section('title', 'Update pickupman')
@section('content')
    <!-- Main content -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="box-content">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="manage-button">
                                    <div class="body-title">
                                        <h5>@lang('common.pickupman') @lang('common.edit')</h5>
                                    </div>
                            ...
                            <form action="{{ url('admin/pickupman/update') }}" method="POST"
                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <div class="main-body">
                                            <div class="row">
                                                <div class="col-md-12 text-center">
                                                    <div class="form-group">
                                                        <label for="image"> @lang('common.pickupman') @lang('common.photo') <span
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="birth_date" id="birth_date"
                                                            class="flatDate form-control  {{ $errors->has('birth_date') ? ' is-invalid' : '' }}"
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="per_parcel_amount"> @lang('common.per_parcel_amount')</label>
