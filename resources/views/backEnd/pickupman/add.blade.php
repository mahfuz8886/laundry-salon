...
@section('pickupman_add', 'active')
@section('title', 'Create pickupman')
@section('content')
    <!-- Main content -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="box-content">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="manage-button">
                                    <div class="body-title">
                                        <h5>@lang('common.pickupman') @lang('common.add')</h5>
                                    </div>
                            ...
                            <!-- form start -->
                            <form action="{{ url('admin/pickupman/save') }}" method="POST" enctype="multipart/form-data">
                                @csrf
