...
@section('title', 'Manage pickupman')
@section('content')
    <!-- Main content -->
                            ...
                            <div class="col-sm-12">
                                <div class="manage-button">
                                    <div class="body-title">
                                        <h5>@lang('common.pickupman') @lang('common.manage')</h5>
                                    </div>
                                    @can('pickupman_add')
                                        <div class="quick-button">
                                            <a href="{{ url('admin/pickupman/add') }}"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul class="action_buttons d-flex">
                                                        <li>
                                                            <a class="edit_icon"
                                                                href="{{ url('admin/pickupman/details/' . $value->id) }}"
                                                                title="Details"><i class="fa fa-eye"></i></a>
                                                        </li>
                                                        @can('pickupman_edit')
                                                            <li>
                                                                @if ($value->status == 1)
                                                                    <form action="{{ url('admin/pickupman/inactive') }}"
                                                                        method="POST">
                                                                        @csrf
                                                                ...
                                                                @else
                                                                    <form action="{{ url('admin/pickupman/active') }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        <input type="hidden" name="hidden_id"
                                                                            value="{{ $value->id }}">
                                                            ...
                                                            <li>
                                                                <a class="edit_icon"
                                                                    href="{{ url('admin/pickupman/edit/' . $value->id) }}"
                                                                    title="Edit"><i class="fa fa-edit"></i></a>
                                                            </li>
                                                        @endcan

                                                        <!--<li>-->
                                                        <!--  <form action="{{ url('admin/pickupman/delete') }}" method="POST">-->
                                                        <!--    @csrf-->
