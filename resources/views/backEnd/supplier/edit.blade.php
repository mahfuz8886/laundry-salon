                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="box-content">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="manage-button">
                                    <div class="body-title">
                                        <h5>@lang('common.supplier') @lang('common.update')</h5>
                                    </div>
                            ...
                            <!-- form start -->
                            <form action="{{ route('superadmin.updateSupplier') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 text-center">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="rowId" value="{{ $supplier->id }}">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="nid_no" id="nid_no"
                                                            ...
                                                            value="{{ old('nid_no', $supplier->nid_no) }}">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="fathers_name" id="fathers_name"
                                                            ...
                                                            value="{{ old('fathers_name', $supplier->fathers_name) }}">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="mothers_name" id="mothers_name"
                                                            ...
                                                            value="{{ old('mothers_name', $supplier->mothers_name) }}">
                                                ...
                                                {{-- <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" state="any" name="prev_due" id="prev_due"
                                                            ...
                                                            value="{{ old('prev_due', $supplier->prev_due) }}">
                                                        ...
                                                        <select name="division_id" id="division_id"
                                                            ...
                                                            @foreach ($divisions as $division)
                                                                <option value="{{ $division->id }}"
                                                                    @if (old('division_id', $supplier->division_id) == $division->id) selected @endif>
                                                                    {{ $division->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
    ...
    <script>
        $(function() {
            ...
            $('body').on('change', '#division_id', function() {
                ...
                var selected = '{{ old('district_id', $supplier->district_id) }}';
                $.ajax({
                    method: "GET",
            ...
            $('body').on('change', '#district_id', function() {
                ...
                var selected = '{{ old('thana_id', $supplier->thana_id) }}';
                $.ajax({
                    method: "GET",
