                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('name', $edit_data->recipientName) }}"
                                                                name="name" id="name" placeholder="Recipient Name"
                                                                required>
                                                            @if ($errors->has('name'))
                                                                <span class="invalid-feedback" role="alert">
                                                                ...
                                                                <select name="pickup_thana_id" id="pickup_thana_id"
                                                                    ...
                                                                    @foreach ($pickup_thanas as $pickup_thana)
                                                                        <option value="{{ $pickup_thana->id }}"
                                                                            @if (old('pickup_thana_id', $edit_data->pickup_thana_id) == $pickup_thana->id) selected @endif>
                                                                            {{ $pickup_thana->name }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                        ...
                                                        {{-- <div class="form-group col-md-12">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('pickLocation', $edit_data->pickLocation) }}"
                                                                name="pickLocation" id="pickLocation"
