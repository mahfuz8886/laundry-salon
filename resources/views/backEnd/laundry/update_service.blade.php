            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="box-content">
                        <form action="{{ route('superadmin.laundry.updateService') }}" method="post">
                            @csrf
                            <div class="card">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="service_name" id="" value="{{ old('service_name', $service->service_name) }}" class="form-control" required>
