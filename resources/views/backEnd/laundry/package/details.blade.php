...
@section('content')
    ...
    <section class="content">
        <form action="{{ route('superadmin.laundry.updatePackage') }}" method="post">
            @csrf
            <div class="container-fluid">
                <div class="card">
                    <h3 class="card-header">Package Details</h3>
                    <div class="card-body">
                        <div class="row">
                        <div class="col-md-7 offset-2">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input disabled type="text" class="form-control" value="{{ $package->package_name??'' }}" name="package_name" id="" required>
                                    <input disabled type="hidden" name="row_id" value="{{ $package->id }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="supplier" class="col-sm-3 col-form-label">Package Amount</label>
                                <div class="col-sm-9">
                                    <input disabled type="number" class="form-control" value="{{ $package->package_amount??0 }}" name="package_amount" id="" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="supplier" class="col-sm-3 col-form-label">Package Duration (day)</label>
                                <div class="col-sm-9">
                                    <input disabled type="number" class="form-control" value="{{ $package->duration??'' }}" name="package_duration" id="" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="supplier" class="col-sm-3 col-form-label"> Max Quantity </label>
                                <div class="col-sm-9">
                                    <input disabled type="number" class="form-control" value="{{ $package->package_quantity ??'' }}" name="package_quantity" id="" required>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select disabled name="branch_id" class="form-control select2" id="branch_id" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select disabled name="status" class="form-control" id="status" required>
                                        <option value="">@lang('common.choose')</option>
                ...
                <!-- <input disabled type="submit" value="Submit" class="btn btn-primary mt-5"> -->
            </div>
        </form>
        ...
        <template>
            <tr>
                ...
                <td>
                    <select disabled name="product[]" id="item" class="form-control" required onchange="loadProduct(this.value,this)">
                        @php
                        $products = App\LaundryProduct::where('status', 'Active')->get();
                        @endphp
                        <option value="">@lang('common.choose')</option>
                ...
                <td>
                    <input disabled type="number" name="amount[]" class="form-control" required>
                </td>
                <td>
                    <input disabled type="number" name="qty[]" class="form-control" required>
                </td>
            </tr>
        </template>
        {{-- template area --}}
