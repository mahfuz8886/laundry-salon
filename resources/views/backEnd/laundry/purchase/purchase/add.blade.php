...
@section('content')
    ...
    <section class="content">
        <form action="{{ route('superadmin.laundry.storePurchase') }}" method="post">
            @csrf
            <div class="container-fluid">
                <div class="card">
                    <h3 class="card-header">Add Purchase</h3>
                    <div class="card-body">
                        <div class="row">
                        <div class="col-md-7 offset-2">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="purchase_date" class="form-control flatDate" id="dateInput" value="{{ date('Y-m-d') }}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                    ...
                    <table class="table table-striped w-100">
                        ...
                        <tbody class="rowContainer">
                            <tr>
                                ...
                                <td style="min-width: 150px"><input type="number" step="any" readonly class="form-control subtotal" name="sub_total[]" required></td>
                            </tr>
                        </tbody>
                        <tfoot>
                                <tr>
                                    <td colspan="5" class="text-right"><b>Invoice Total</b></td>
                                    <td style="min-width: 150px"><input type="number" step="any" readonly class="form-control" name="invoice_total" id="invoiceTotal" required></td>
                                </tr>
                                <tr>
                                    <td colspan="5" class="text-right"><b>Discount</b></td>
                                    <td style="min-width: 150px"><input type="text" placeholder="Discount" class="form-control" name="discount" onkeyup="addDiscount(this)" id="discount"></td>
                                </tr>
                                <tr>
                                    <td colspan="5" class="text-right"><b>Payable amount</b></td>
                                    <td style="min-width: 150px"><input type="number" step="any" readonly placeholder="Payable" class="form-control" name="payable" id="payable"></td>
                                </tr>
                                <tr>
                                    <td colspan="5" class="text-right"><b>Paid amount</b></td>
                                    <td style="min-width: 150px"><input type="number" step="any" placeholder="Paid" onkeyup="paidAmount(this)" class="form-control" name="paid" id="paid"></td>
                                </tr>
                                <tr>
                                    <td colspan="5" class="text-right"><b>Due amount</b></td>
                                    <td style="min-width: 150px"><input type="number" step="any" readonly placeholder="Due" class="form-control" name="due" id="due"></td>
                                </tr>
                                <tr>
                                    <td colspan="6" class="text-right"><button type="submit" class="btn btn-primary btn-sm">submit</button></td>
                                </tr>
                        </tfoot>
                    </table>
                </div>
