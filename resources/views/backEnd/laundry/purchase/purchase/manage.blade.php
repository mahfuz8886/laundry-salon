                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                @forelse ($purchases as $item)
                                    <tr>
                                        <td>
                                            <a href="{{ route('superadmin.laundry.getPurchase', $item->id) }}" class="mr-2"><i class="fa fa-edit"></i></a>
                                            <a href="{{ route('superadmin.laundry.detailsPurchase', $item->id) }}" class="mr-2"><i class="fa fa-desktop"></i></a>
                                        </td>
