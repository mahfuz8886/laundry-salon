...
@section('content')
    ...
    <section class="content">
        <form action="{{ route('superadmin.laundry.updatePurchase') }}" method="post">
            @csrf
            <div class="container-fluid">
                <div class="card">
                    <h3 class="card-header">Update Purchase</h3>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="branch_id" class="form-control select2" id="branch_id" required>
                                        ...
                                        <option {{ $purchase->branch_id==$branch->id? 'selected':'' }} value="{{ $branch->id }}">{{ $branch->title }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
