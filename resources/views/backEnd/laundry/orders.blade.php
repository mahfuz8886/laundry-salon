                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="is_package_order" class="form-control select2">
                                        <option value=""></option>
                                        <option {{$_GET && $_GET['is_package_order'] == 0? 'selected':''}} value="0">Product</option>
                                        <option {{$_GET && $_GET['is_package_order'] == 1? 'selected':''}} value="1">Package and/or Product</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-6">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <a href="{{ route('superadmin.laundry.orderdetails', $order->id) }}" class="mr-2"><i class="fa fa-desktop"></i></a>
                                        <a href="#" class="mr-2"><i class="fa fa-print"></i></a>
                                        <a href="{{ route('superadmin.laundry.getorderitems', $order->id) }}" class="mr-2"><i class="fas fa-edit"></i></a>
                                    </td>
