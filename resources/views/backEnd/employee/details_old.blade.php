                ...
                <div class="row print_area">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <div class="card custom-card">
                            <div class="col-sm-12">
                                <img class="profile_image" src="{{ url($employee->image) }}" alt="Photo">
                                <br>
                            ...
                            <div class="card-body">
                                <table class="table profile_table">
                                    ...
                                    <tr>
                                        ...
                                        <td  colspan="1" width="30%"> {{ $employee->birth_date?date('d-m-Y', strtotime($employee->birth_date)):'' }} </td>
                                        <th width="20%" colspan="1" class="text-right"> Religion <span style="float: right"><b>:</b></span> </th>
                                        <td  colspan="1"> {{ $employee->religion }} </td>
                                    </tr>
                                    <tr>
                                        <th width="25%" colspan="1"> Maritial Status <span style="float: right"><b>:</b></span> </th>
                                        <td  colspan="1" width="30%"> {{ $employee->marital_status }} </td>
