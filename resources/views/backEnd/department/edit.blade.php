              ...
              <div class="col-sm-12">
                  <div class="manage-button">
                    <div class="body-title">
                      <h5>@lang('common.department') @lang('common.edit')</h5>
                    </div>
              ...
              <div class="col-lg-12 col-md-12 col-sm-12">
                  <div class="card card-primary">
                    <div class="card-header">
                      <h3 class="card-title">@lang('common.department') @lang('common.edit')</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-12">
                        <div class="form-group">
                          <label for="name">@lang('common.department')</label>
