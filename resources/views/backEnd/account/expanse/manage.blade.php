                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($income_lists as $income_list)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @foreach ($income_list->expanse_transection as $item)
                                                            {{ $item->account_head->head_name .", " }}
                                                        @endforeach
                                                    </td>
                                                    <td>
                                                        <a class="pr-2" href="{{ route('superadmin.account.expanseEdit', $income_list->id) }}"><i class="fa fa-edit text-primary"></i></a>
                                                        <a class="pr-2" href="{{ route('superadmin.account.expanseDelete', $income_list->id) }}"><i class="fa fa-trash text-danger"></i></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
