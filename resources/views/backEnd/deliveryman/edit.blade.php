...
@section('title', 'Update deliveryman')
@section('content')
    <!-- Main content -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="box-content">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="manage-button">
                                    <div class="body-title">
                                        <h5>@lang('common.deliveryman') @lang('common.edit')</h5>
                                    </div>
                            ...
                            <form action="{{ url('admin/deliveryman/update') }}" method="POST"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 text-center">
                                                    <div class="form-group">
                                                        <label for="image"> @lang('common.deliveryman') @lang('common.photo') <span
