                                ...
                                <table id="example1" class="table table-bordered table-striped custom-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th> @lang('common.delivery_charge_head') </th>
                                            <th>@lang('common.delivery_charge')</th>
                                            <th>@lang('common.extra_delivery_charge')</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul class="action_buttons">
                                                        <li>
                                                            @if ($value->status == 1)
                                                                <form action="{{ url('admin/deliverycharge/inactive') }}"
                                                                    method="POST">
                                                                    @csrf
                                                            ...
                                                            @else
                                                                <form action="{{ url('admin/deliverycharge/active') }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    <input type="hidden" name="hidden_id"
                                                                        value="{{ $value->id }}">
                                                        ...
                                                        <li>
                                                            <a class="edit_icon"
                                                                href="{{ url('admin/deliverycharge/edit/' . $value->id) }}"
                                                                title="Edit"><i class="fa fa-edit"></i></a>
                                                        </li>
                                                        {{-- <li>
                                                            <form action="{{ url('admin/deliverycharge/delete') }}"
                                                                method="POST">
                                                                @csrf
                                                                <input type="hidden" name="hidden_id"
                                                                    value="{{ $value->id }}">
