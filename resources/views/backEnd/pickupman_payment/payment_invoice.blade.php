                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4" style="width: 40%; float: left;">
                                        ...
                                        <div class="supplier_info">
                                            <b> @lang('common.pickupman') @lang('common.information')</b> <br>
                                            @lang('common.name') : {{ $parcel->pickupman->name ?? '' }} <br>
                                            @lang('common.mobile_no') : {{ $parcel->pickupman->phone ?? '' }} <br>
                                            @lang('common.address') : {{ $parcel->pickupman->present_address ?? '' }}
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-left"> {{ $parcel->pickupman_amount }} </td>
                                                    <td class="text-left"> {{ $parcel->pickupman_paid }} </td>
                                                    <td class="text-left"> {{ $parcel->pickupman_due }} </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
