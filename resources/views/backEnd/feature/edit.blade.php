            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ url('editor/feature/manage') }}">@lang('common.feature')</a></li>
                ...
                <div class="col-sm-12">
                    <div class="manage-button">
                        <div class="body-title">
                            <h5>@lang('common.feature') @lang('common.update')</h5>
                        </div>
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8">
                                <div class="card card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">@lang('common.feature') @lang('common.update')</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form role="form" action="{{ url('editor/feature/update') }}" method="POST"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('title', $edit_data->title) }}" name="title" id="title">
                                                @if ($errors->has('title'))
                                                    <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control {{ $errors->has('title_bn') ? ' is-invalid' : '' }}" value="{{ old('title_bn', $edit_data->title_bn) }}" name="title_bn" id="title">
                                            ...
                                            <div class="form-group">
                                                <label for="subtitle">@lang('common.sub_title') </label>
                                                <input type="text"
                                                    class="form-control {{ $errors->has('subtitle') ? ' is-invalid' : '' }}"
                                                    value="{{ old('subtitle', $edit_data->subtitle) }}" name="subtitle" id="subtitle">
                                            ...
                                            <!-- form group -->
                                            <div class="form-group">
                                                <label for="subtitle_bn">Sub Title Bangla </label>
                                                <input type="text" class="form-control {{ $errors->has('subtitle_bn') ? ' is-invalid' : '' }}" value="{{ old('subtitle_bn', $edit_data->subtitle_bn) }}" name="subtitle_bn" id="subtitle_bn">
                                                    @if ($errors->has('subtitle_bn'))
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $errors->first('subtitle_bn') }}</strong>
                                                    </span>
                                                    @endif
                                            </div>
                                            <!-- form group -->
