                ...
                <div class="col-sm-12">
                    <div class="manage-button">
                        <div class="body-title">
                            <h5>@lang('common.feature') @lang('common.manage')</h5>
                        </div>
                                                ...
                                                <td>
                                                    <ul class="action_buttons dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                @if ($value->status == 1)
                                                                    <form action="{{ url('editor/feature/inactive') }}"
                                                                        method="POST">
                                                                        @csrf
                                                                ...
                                                                @else
                                                                    <form action="{{ url('editor/feature/active') }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        <input type="hidden" name="hidden_id"
                                                                            value="{{ $value->id }}">
                                                            ...
                                                            <li>
                                                                <a class="edit_icon"
                                                                    href="{{ url('editor/feature/edit/' . $value->id) }}"
                                                                    title="Edit"><i class="fa fa-edit"></i> @lang('common.edit')</a>
                                                            </li>
                                                            <li>
                                                                <form action="{{ url('editor/feature/delete') }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    <input type="hidden" name="hidden_id"
                                                                        value="{{ $value->id }}">
