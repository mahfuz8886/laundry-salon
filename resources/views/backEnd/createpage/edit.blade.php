...
@section('content')
                ...
                <div class="col-sm-12">
                    <div class="manage-button">
                        <div class="body-title">
                            <h5>@lang('common.page') @lang('common.update')</h5>
                        </div>
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8">
                                <div class="card card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">@lang('common.page') @lang('common.update')</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form role="form" action="{{ url('editor/createpage/update') }}" method="POST"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ $edit_data->pageName }}" name="pageName" id="pageName">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control {{ $errors->has('pageName_bn') ? ' is-invalid' : '' }}" value="{{$edit_data->pageName_bn }}" name="pageName_bn" id="pageName_bn">
    ...
    <script type="text/javascript">
        document.forms['editForm'].elements['page_area'].value = "{{ $edit_data->page_area }}"
