                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th> @lang('common.slider_sdesc')  </th>
                                    ...
                                    <tbody>
                                        @foreach ($show_data as $key => $value)
                                            <tr>
                                                ...
                                                <td>{{ $value->name }}</td>
                                                <td>{{ $value->slider_sdesc}}</td>
                                                <td>
                                                    <img src="{{ asset($value->image) }}" height="60" width="150" class="" alt="">
                                                </td>
                                                ...
                                                <td>
                                                    <ul class="action_buttons dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                @if ($value->status == 1)
                                                                    <form action="{{ url('editor/slider/inactive') }}"
                                                                        method="POST">
                                                                        @csrf
                                                                ...
                                                                @else
                                                                    <form action="{{ url('editor/slider/active') }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        <input type="hidden" name="hidden_id"
                                                                            value="{{ $value->id }}">
                                                            ...
                                                            <li>
                                                                <a class="edit_icon"
                                                                    href="{{ url('editor/slider/edit/' . $value->id) }}"
                                                                    title="Edit"><i class="fa fa-edit"></i> @lang('common.edit')</a>
                                                            </li>
                                                            <li>
                                                                <form action="{{ url('editor/slider/delete') }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    <input type="hidden" name="hidden_id"
                                                                        value="{{ $value->id }}">
