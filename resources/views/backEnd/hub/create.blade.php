          ...
          <div class="col-sm-12">
            <div class="manage-button">
              <div class="body-title">
                <h5>@lang('common.hub') @lang('common.hub')</h5>
              </div>
              ...
              <div class="col-lg-8 col-md-8 col-sm-8">
                  <div class="card card-primary">
                    <div class="card-header">
                      <h3 class="card-title">@lang('common.add_hub')</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="{{url('editor/hub/store')}}" method="POST" enctype="multipart/form-data">
                      @csrf
                      <div class="card-body">
                        ...
                        <!-- form group -->
                        {{-- <div class="form-group">
                          <label for="subtitle_bn">@lang('common.sub_title_bn')</label>
                              <input type="text" class="form-control {{ $errors->has('subtitle_bn') ? ' is-invalid' : '' }}" value="{{ old('subtitle_bn') }}" name="subtitle_bn" id="subtitle_bn">
