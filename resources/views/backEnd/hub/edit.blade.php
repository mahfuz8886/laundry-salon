      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active"><a href="#">@lang('common.hub')</a></li>
          ...
          <div class="col-sm-12">
            <div class="manage-button">
              <div class="body-title">
                <h5>@lang('common.hub') @lang('common.update')</h5>
              </div>
              <div class="quick-button">
                <a href="{{url('editor/hub/manage')}}" class="btn btn-primary btn-actions btn-create">
                @lang('common.manage')
                </a>
              ...
              <div class="col-lg-8 col-md-8 col-sm-8">
                  <div class="card card-primary">
                    <div class="card-header">
                      <h3 class="card-title">@lang('common.update') @lang('common.hub')</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="{{url('editor/hub/update')}}" method="POST" enctype="multipart/form-data" name="editForm">
                      @csrf
                      ...
                      <div class="card-body">
                        ...
                        {{-- <div class="form-group">
                          <label for="subtitle_bn">Sub Title Bangla</label>
                              <input type="text" class="form-control {{ $errors->has('subtitle_bn') ? ' is-invalid' : '' }}" value="{{$edit_data->subtitle_bn }}" name="subtitle_bn" id="subtitle_bn">
                        ...
                        <div class="form-group">
                          <label for="text_bn">@lang('common.description_bn')</label>
                              <textarea type="text" class="summernote form-control {{ $errors->has('text_bn') ? ' is-invalid' : '' }}" value="{{ old('text_bn') }}" name="text_bn">{!!$edit_data->text_bn !!}</textarea>
