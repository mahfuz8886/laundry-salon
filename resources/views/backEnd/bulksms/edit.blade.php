                    ...
                    <form role="form" action="{{url('editor/banner/update')}}" method="POST" enctype="multipart/form-data" name="editForm">
                      ...
                      <div class="card-body">
                        ...
                        <div class="form-group">
                              ...
                              <select type="text"  class="form-control{{ $errors->has('type') ? ' is-invalid' : '' }}" value="{{ old('type') }}" name="type" placeholder="Invoice or Memo Number" required="required">
                                  <option value="">Select...</option>
                                  <option value="1" @if($edit_data->type==1) selected @endif>Main Banner</option>
                                  <option value="2" @if($edit_data->type==2) selected @endif>Ads Banner</option>
                              </select>    
                               @if ($errors->has('type'))
