...
@section('content')
                            ...
                            @foreach ($allparcel as $key => $value)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @elseif($value->pickupmanId && $value->deliverymanId)
                                            <p>@lang('common.pickupman_assign')</p>
                                            <p>@lang('common.deliveryman_assign')</p>
                                        @endif
                                    </td>
    ...
    <div id="sUpdateModal{{ $value->id }}" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <!-- Modal content-->
            <form action="{{ url('deliveryman/asign') }}" method="POST">
                @csrf
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="deliverymanId" value="{{ session()->get('deliverymanId') }}">
