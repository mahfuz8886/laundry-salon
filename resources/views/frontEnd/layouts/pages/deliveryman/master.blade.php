...
<body>
        ...
        <div class="swipe-menu default-theme">
            ...
            <nav class="codehim-nav">
                <ul class="menu-item">
                    ...
                    {{-- <li>
                        <a href="{{ url('deliveryman/dashboard') }}">@lang('common.dashborad')</a>
                    </li> --}}
                    ...
                    {{-- <li>
                        <a href="{{ url('deliveryman/payments/all') }}" class="mcreate_parcel">
                        @lang('common.payments')
                        </a>
                    </li> --}}
                    <li><a href="{{ url('deliveryman/logout') }}" class="agent-logout">@lang('common.logout')</a>
                    </li>
                </ul>
                <!--//Tab-->
            </nav>
        ...
        <div class="dash-sidebar">
            <div class="sidebar-inner">
                ...
                <div class="side-list">
                    <ul>
                        <li>
                            <a href="{{ url('/deliveryman/dashboard') }}" class="text-left @yield('dashboard')">
                                <div class="dashboard-button"><i class="fa fa-home">
                                    </i> &nbsp; @lang('common.dashborad') 
                                </div>
                            </a>
                        </li>
                        {{-- <li>
                            <a href="{{ url('deliveryman/pending-parcels') }}" class="text-left @yield('pending_parcels')">
                                <div class="dashboard-button"><i class="fa fa-car">
                                    </i> &nbsp; @lang('common.my_assignable_parcel')
                                </div>
                            </a>
                        </li> --}}
                        <li>
                            <a href="{{ url('deliveryman/parcels') }}" class="text-left @yield('parcels')">
                                <div class="dashboard-button"><i class="fas fa-shopping-cart"></i> &nbsp; @lang('common.orders')</div>
                            </a>
                        </li>
                        {{-- <li>
                            <a href="{{ url('deliveryman/payments/all') }}" class="text-left @yield('my_payments')">
                                <div class="dashboard-button"><i class="fa fa-car">
                                    </i> &nbsp; @lang('common.payments')
                                </div>
                            </a>
                        </li> --}}
                        {{-- <li>
                        ...
                        <li>
                            <a href="{{ url('deliveryman/logout') }}" class="text-left">
                        ...
                        <div class="heading-right">
                            <ul>
                                    ...
                                    <div class="track-area">
                                        <form action="{{ url('/deliveryman/parcel/track') }}" method="POST">
                                            ...
                                            <input class="form-control" type="text" name="trackid"
                                                placeholder="@lang('common.parcel_id')" search>
                                ...
                                <li class="nav-item has-treeview">
                                    <a href="{{ url('deliveryman/parcels') }}" class="nav-link" title="All orders">
                                ...
                                <li class="profile-area" style="margin-right: 0px !important;">
                                    <div class="profile">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="{{ url('deliveryman/logout') }}">@lang('common.logout')</a></li>
                                        </ul>
                                    </div>
                                </li>
                                <li style="margin-right: 0px !important;">
                                    <div style="display: flex;justify-content: end;height: 100%;align-items: center;">
                                        @if (Session::get('locale') == 'en')
                                            <a href="{{ url('locale/bn') }}" class="mlang text-primary"><i class="fas fa-globe" aria-hidden="true"></i> বাংলা</a>
                                        @else
    ...
    <script>
        ...
        var url = "{{route('deliveryman.laundry.getNewAssignOrders')}}";
        // console.log(url);
