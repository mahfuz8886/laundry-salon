    ...
    <body>
                            ...
                            <div class="topbar-right ml-auto">
                                <ul class="list-inline mb-0">
                                    ...
                                    <li class="list-inline-item mr-0 u-header-topbar__nav-item u-header-topbar__nav-item-border full-bg">
                                        ...
                                        <span class="u-header-topbar__nav-link"><a class="text-info" href="{{ url('merchant/register') }}">Register</a> or <a class="text-success" href="{{ url('merchant/login') }}">Sign in</a></span>
                                            ...
                                            <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                ...
                                                <div class="hs-mega-menu w-100 u-header__sub-menu" aria-labelledby="pagesMegaMenu">
                                                    <div class="row u-header__mega-menu-wrapper">
                                                        @foreach($hubs as $hub)
                                                        <div class="col-md-3">
                                                            <a href="{{ url('/') }}"><span class="u-header__sub-menu-title">{{ $hub->title }}</span></a>
                                                        </div>
                                                        @endforeach
                                                    </div>
                                                </div>
                            ...
                            <div class="col align-self-center">
                                ...
                                <form class="js-focus-state">
                                    ...
                                    <div class="input-group">
                                        <input type="search" class="form-control py-2 pl-5 font-size-15 border-0 height-40 rounded-left-pill" name="email" id="searchProduct" placeholder="Search for Products" aria-label="Search for Products" aria-describedby="searchProduct1" required>
                                        <div class="input-group-append">
        ...
        <main id="content" role="main" class="py-5">
            ...
            <div class="d-flex flex-column flex-md-row">
                {{-- sidebar --}}
                <div class="col-12 col-md-2 border ml-4 bg-warning text-light pt-3 rounded">

                    @php
                        $merchantInfo = App\Customer::find(Session::get('merchantId'));
                    @endphp
                        ...
                        <div class="swipe-menu default-theme">
                            <div class="postyourad">
                                <a href="{{url('merchant/dashboard')}}">
                                    ...
                                    <img style="width: 40px;height:40px;" class="rounded" src="{{asset($merchantInfo->logo)}}" alt="Your logo"/>
                                    
                                </a>
                                <a  href="{{url('merchant/dashboard')}}" class="mobile-username text-light">{{$merchantInfo->firstName}}</a>
                            </div>
                        <!--Navigation Icon-->
                            
                            <ul class="nav flex-column mt-2">
                                <li class="nav-item"> <a class="nav-link @yield('dashboard') text-light" href="{{url('/merchant/dashboard')}}">@lang('common.dashborad')</a> </li>

                                <li class="nav-item"> <a class="nav-link @yield('orders') text-light" href="{{route('merchant.orders')}}">@lang('common.orders')</a> </li>
                                
                                <li class="nav-item"> <a class="nav-link text-light" href="{{url('merchant/logout')}}">@lang('common.logout')</a></li>
                            </ul>
                        </div>
                    </section>
                    <!-- mobile menu end -->

                    <div class="dash-sidebar d-none d-md-block" style="min-height: 500px">
                        <div class="sidebar-inner">
                            <div class="profile-inner">
                                <div class="profile-pic text-center">
                                    <a href="#"><img style="max-width: 70px;max-height:70px;border-radius:50%" src="{{asset('public/frontEnd')}}/images/avator.png" alt=""></a>
                                </div>
                                <div class="profile-id">
                                    @php
                                        $merchantInfo = App\Customer::find(Session::get('merchantId'));
                                    @endphp
                                    <p class="text-light text-center">{{$merchantInfo->firstName}}</p>
                                </div>
                            ...
                            <div class="side-list">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a href="{{url('merchant/dashboard')}}" class="nav-link @yield('dashboard') text-light">
                                    ...
                                    <li class="nav-item ml-0">
                                        <a href="{{route('merchant.orders')}}" class="nav-link @yield('orders') text-light">
                                            <div class="dashboard-button"> <i class="fas fa-shopping-cart"></i>
                                            @lang('common.orders')
                                            </div>
                                        </a>
                                    </li>
                                    ...
                                    <li class="nav-item ml-1">
                                        <a href="{{url('merchant/logout')}}" class="nav-link text-light">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <div class="row">
                                ...
                                <div class="col-12 col-md mb-4 mb-md-0">
                                    <h6 class="mb-3 font-weight-bold" id="footer-menu">Login Infrmation.</h6>
                                    <!-- List Group -->
                                    <ul class="list-group list-group-flush list-group-borderless mb-0 list-group-transparent">
