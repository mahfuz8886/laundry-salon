            ...
            <form action="{{url('merchant/support')}}" method="POST" name="editForm">
                ...
                @endphp
                   <div class="form-group row">
                      <div class="col-lg-3 col-md-4 col-sm-4"><p>@lang('common.subject') </p></div>
                  ...
                  <!-- form-group end -->
                  <div class="form-group row">
                      <div class="col-lg-3 col-md-4 col-sm-4"><p>@lang('common.description')</p></div>
                      <div class="col-lg-6 col-md-8 col-sm-8">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-3"><input type="submit" value="@lang('common.send_message')"class="common-btn"></div>
                  </div>
            </div>
            </form>
        </div>
