                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control select2">
                                        ...
                                        <option @if (Request::get('status')) {{ $_GET['status'] == $type->id ? 'selected':''  }} @endif value="{{ $type->id }}">{{ $type->title }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="payment_status" class="form-control select2">
                                        <option value=""></option>
                                        <option @if (Request::get('payment_status')) {{ $_GET['payment_status'] == 'Paid' ? 'selected':''  }} @endif value="1"> Paid </option>
                                        <option @if (Request::get('payment_status')) {{ $_GET['payment_status'] == 'Unpaid' ? 'selected':''  }} @endif value="0"> Unpaid </option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-6">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <a href="{{ route('merchant.orderdetails', $order->id) }}" class="mr-2"><i class="fa fa-desktop"></i></a>
                                    </td>
