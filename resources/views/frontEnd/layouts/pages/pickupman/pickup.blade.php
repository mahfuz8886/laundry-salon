                            ...
                            @foreach ($show_data as $key => $value)
                                <tr>
                                    ...
                                    @php
                                        ...
                                        $pickupmanInfo = App\Pickupman::find($value->pickupman);
                                    @endphp
                                    ...
                                    <td>
                                        <ul>
                                            <li>
                                                <button class="btn btn-info" title="Action" data-toggle="modal"
                                                    ...
                                                    <div class="modal-dialog">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="{{ url('pickupman/pickup/status-update') }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    ...
                                                                    <div class="form-group">
                                                                        <select name="status" class="form-control" id="">
                                                                            <option value="1"
                                                                                @if ($value->status == 1) selected="selected" @endif>
                                                                                Pending</option>
                                                                            <option value="2"
                                                                                @if ($value->status == 2) selected="selected" @endif>
                                                                                Accepted</option>
                                                                            <option value="3"
                                                                                @if ($value->status == 3) selected="selected" @endif>
                                                                                Cancelled</option>
                                                                        </select>
                                                                    </div>
                                                                    <!-- form group end -->
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <table class="table table-bordered">
                                                                    <tr>
                                                                        <td>Merchant Name</td>
                                                                        <td>{{ $merchant->firstName }}
                                                                            {{ $merchant->lastName }}</td>
                                                                    </tr>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td>Pickup type</td>
                                                                        <td>
                                                                            @if ($value->pickuptype == 1)
                                                                                Next Day Delivery
                                                                            @elseif($value->pickuptype == 2)
                                                                                Same Day Delivery
                                                                            @endif
                                                                        </td>
                                                                    </tr>
