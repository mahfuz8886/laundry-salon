                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <a href="{{ route('pickupman.orderdetails', $order->id) }}" class="mr-2"><i class="fa fa-desktop"></i></a>
                                        <a href="{{ route('pickupman.getorderitems', $order->id) }}" class="mr-2"><i class="fas fa-edit"></i></a>
                                    </td>
