                ...
                <div class="my-md-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-3 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
                            ...
                            <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1"><a href="#">@lang('common.product_details')</a></li>
                        </ol>
                    </nav>
                </div>
                <!-- End breadcrumb -->
                ...
                <div class="row">
                    <div class="col-md-5 mb-4 mb-md-0">
                        <div id="sliderSyncingNav" class="js-slick-carousel u-slick mb-2"
                            ...
                            <div class="js-slide">
                                <img class="img-fluid" src="{{ asset($details->image) }}" alt="Image Description">
                            </div>
                            {{-- <div class="js-slide">
                    ...
                    <div class="col-md-7 mb-md-6 mb-lg-0">
                        <div class="mb-2">
                            <div class="border-bottom mb-3 pb-md-1 pb-3">
                                <a href="#" class="font-size-12 text-gray-5 mb-2 d-inline-block">{{ $details->category->cat_name }}</a>
                                <h2 class="font-size-25 text-lh-1dot2">{{ $details->product_name }}</h2>
                                <div class="mb-2">
                            ...
                            <div class="mb-4">
                                <div class="d-flex align-items-baseline">
                                    <ins class="font-size-36 text-decoration-none">৳ {{ $details->price_range }}</ins>
                            ...
                            <div class="d-md-flex align-items-end mb-3">
                                    ...
                                    <div class="border rounded-pill py-2 px-3 border-color-1">
                                        <div class="js-quantity row align-items-center">
                                            ...
                                            <div class="col-auto pr-1">
                                                <a class="btn btn-icon btn-xs btn-outline-secondary rounded-circle border-0" href="javascript:;" onclick="decreamentQuantity()">
                                                    <small class="fas fa-minus btn-icon__inner"></small>
                                                </a>
                                                <a class="js-plus btn btn-icon btn-xs btn-outline-secondary rounded-circle border-0" href="javascript:;" onclick="increamentQuantity()">
                                ...
                                <div class="ml-md-3">
                                    <button type="button" class="btn px-5 btn-primary-dark transition-3d-hover addToCartBtn" data-id="{{$details->id}}"><i class="ec ec-add-to-cart mr-2 font-size-20"></i>@lang('common.add_to_cart')</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('script')
    <script>
        ...
        $('body').on('click','.addToCartBtn', function() {
            ...
            if(serviceId == 0) {
                alert('Please select a serive first.');
            }else {
                //when all ok
                $.ajax({
                    type:'POST',
                    url:"{{ route('product.addtocart') }}",
                    data:{serviceId,quantity,productID },
