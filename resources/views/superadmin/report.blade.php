                    ...
                    <table id="example" class="table table-bordered table-striped custom-table table-responsive">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>@if($value->pickupmanId)
                           <button class="btn btn-primary" data-toggle="modal" data-target="#pickupmanModal{{$value->id}}"> {{$pickupmanInfo->name}} 
                          </button> @else
                           <button class="btn btn-primary" data-toggle="modal" data-target="#pickupmanModal{{$value->id}}">Asign</button>
                            @endif</td>
                          ...
                          <td>@if($value->deliverymanId) <button class="btn btn-primary" data-toggle="modal" data-target="#asignModal{{$value->id}}">{{$deliverymanInfo->name}}</button> 
                             @else <button class="btn btn-primary" data-toggle="modal" data-target="#asignModal{{$value->id}}">Asign</button> @endif</td>
                          <!-- Modal -->
