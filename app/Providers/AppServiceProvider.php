...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
       ...
       $parceltypes = Parceltype::get();
        ...
        $pagelistleft = Createpage::where(['status'=>1, 'page_area'=>'Left Area'])->take(5)->get();
        view()->share('pagelistleft',$pagelistleft);

        $pagelistright = Createpage::where(['status'=>1, 'page_area'=>'Right Area'])->take(5)->get();
        view()->share('pagelistright',$pagelistright);
