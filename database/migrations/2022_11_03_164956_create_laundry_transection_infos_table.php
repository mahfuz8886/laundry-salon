...
class CreateLaundryTransectionInfosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('laundry_transection_infos', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('laundry_transection_infos');
    }
}
